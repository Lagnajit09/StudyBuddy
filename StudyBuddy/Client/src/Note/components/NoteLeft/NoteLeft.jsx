      ...
      <div className="all-div">
        ...
        <div className="topic-wrapper">
          <div
            ...
            style={{
              color: pathname.includes("/topic") ? "#00a9ff" : "#000000",
            }}
          >
            <PiNotebook
              style={{
          ...
          <div className="topics-list">
            <span
              ...
              style={{
                backgroundColor: topicClicked == "Bio" ? "#f5f8ff" : "#ffffff",
              }}
              onClick={() => {
                setTopicClicked("Bio");
            ...
            <span
              ...
              style={{
                backgroundColor: topicClicked == "Phy" ? "#f5f8ff" : "#ffffff",
              }}
              onClick={() => {
                setTopicClicked("Phy");
            ...
            <span
              ...
              style={{
                backgroundColor: topicClicked == "Chem" ? "#f5f8ff" : "#ffffff",
              }}
              onClick={() => {
            ...
            <span
              className="IT-topics"
              style={{
                backgroundColor: topicClicked == "IT" ? "#f5f8ff" : "#ffffff",
              }}
              onClick={() => {
                setTopicClicked("IT");
            ...
            <span
              ...
              style={{
                backgroundColor: topicClicked == "Math" ? "#f5f8ff" : "#ffffff",
              }}
              onClick={() => {
            ...
            <span
              ...
              style={{
                backgroundColor:
                  topicClicked == "Cloud" ? "#f5f8ff" : "#ffffff",
              }}
              onClick={() => {
        ...
        <div className="trash-wrapper">
          ...
          <div className="trash-list">
            ...
            <span
              ...
              style={{
                backgroundColor:
                  pathname === "/note/trash/note" ? "#f5f8ff" : "#ffffff",
              }}
            >
              <LiaStickyNoteSolid style={{ strokeWidth: "1px" }} />
              Notes
